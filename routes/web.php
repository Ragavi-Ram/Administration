...
Route::group(['namespace' => '\LaraSnap\LaravelAdmin\Controllers','prefix' => 'admin', 'middleware' => ['web', 'auth', 'check-userstatus'], 'roles' => '' ], function(){
    ...
    Route::group(['middleware' => ['check-roles'] ], function(){
        ...
        /** ROLE ROUTES **/	
        /** EMPLOYEE ROUTES **/	
        Route::group(['prefix' => 'employees', 'exculde' => ['employees.filter', 'employees.store', 'employees.update', 'employees.assignpermission_store', 'employees.assignscreen_store']], function(){
            ...
            Route::put('{id}','EmployeeController@update')->name('employee.update');
